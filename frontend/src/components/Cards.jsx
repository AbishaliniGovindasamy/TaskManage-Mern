          ...
          >
            ...
            <div className="mt-4 w-full flex items-center">
              ...
              <div className="text-white p-2 w-3/6 text-2xl font-semibold flex justify-around">
                <button title="Favorite" onClick={() => handleImportant(items._id)}>
                ...
                {home !== "false" && (<button title="Edit" onClick={() => handleUpdate(items._id, items.title, items.desc)}>
                  <FaEdit />
                </button>)}
                <button title="Delete" onClick={() => deleteTask(items._id)}>
                  <MdDelete />
                </button>
              </div>
            </div>
